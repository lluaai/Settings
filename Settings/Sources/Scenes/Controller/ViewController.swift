...
//  Settings
//
//  Created by Арайлым Сермагамбет on 02.05.2024.
//
        ...
        func configure() {
            ...
            models.append(Section(name: "General", options: [
                ...
                print("Уведомления")
                    ...
                    .staticCell(model: Setting(name: "Звуки, тактильные сигналы",icon: .display, iconBackgroudColor: .systemPink){
            ...
            models.append(Section(name: "General", options: [
                .staticCell(model: Setting(name: "Основные",icon: .focus, iconBackgroudColor: .systemGray, iconNumber: UIImage(systemName: "1.circle.fill")){
                print("Основныя")
            }),
